...
<body class="home">
        ...
        <header id="header" class="header-scroll top-header headrom">
            ...
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <img class="img-rounded" src="images/alwayscoffee.png" alt="" width="60" height="60">
                    </a>

                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="coffeeshop.php">Coffee Shops<span class="sr-only"></span></a> </li>
        ...
        <!-- banner part starts -->
        <section class="hero bg-image" data-image-src="images/banner.jpg" style="height: 765px;">
            <div class="hero-inner">
            <div class="container text-center hero-text font-white">
                    <h1>Choose it & Enjoy your coffee! </h1>
                    <h5 class="font-white space-xs">Order the best coffee here in Cagayan de Oro City!</h5>
                    <div class="banner-form">
                        <form class="form-inline">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I would like to drink....</label>
                                <div class="form-group">
                                    <input type="text" class="form-control form-control-lg" id="exampleInputAmount" placeholder="I would like to drink...."> </div>
                            </div>
                            <button onclick="location.href='coffeeshop.php'" type="button" class="btn theme-btn btn-lg">Search</button>
                        </form>
                    </div>
                    <div class="steps">
                        <div class="step-item step1">
                            ...
                            <h4 style="font-weight:bold; font-size:25px;">1. Find Always Coffee Near You!</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step2">
                            ...
                            <h4 style="font-weight:bold; font-size:25px;">2. Order Coffee</h4> </div>
                        <!-- end:Step -->
                        <div class="step-item step3">
                            <svg xmlns="http://www.w3.org/2000/svg" width="512" height="512" viewbox="0 0 612.001 612">
                                ...
                                <h4 style="font-weight:bold; font-size:25px;">3. Get Delivered</h4> </div>
                        <!-- end:Step -->
                    </div>
                    <!-- end:Steps -->
                </div>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Popular Coffee of this Week</h2>
                ...
                <div class="row" style="padding:0 250px;">
						...
						$query_res= mysqli_query($db,"select * from dishes LIMIT 3"); 
									      while($r=mysqli_fetch_array($query_res))
										  {
						                       ...
						                       echo '  <div class="col-sm-6 col-sm-5 col-md-4 food-item">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a Coffee Shop</h3>
                                    <p>We got you covered with more than 600+ popular delivery coffee shops.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <h3>Choose your favorite coffee</h3>
                                <p>We are serving you more than 3000+ popular coffee varieties.</p>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                            <div class="step step-3">
                                ...
                                <p>Get your food delivered within 15 mins and enjoy your coffee..!</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="title-block pull-left">
                            <h4>Featured Always Coffee Branches</h4> </div>
                    </div>
                    <div class="col-sm-8">
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            <div class="col-xs-12 col-sm-5 right-image text-center">
                                <figure> <img src="images/phone-2.png" alt="Right Image" class="img-fluid"> </figure>
                            </div>
                            <div class="col-xs-12 col-sm-7 left-text">
                                <h3>Always Coffee - The Best Coffee Delivery App</h3>
                                <p>Need more energy? Get the coffee you want, from the restaurants you love, delivered at blinking speed.

								Drink what you like, where you like, when you like. Find the local flavours you crave, all at the tap of a button.</p>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/food-picky-logo.png" alt=""> </a> <span>Choose it &amp; Enjoy your coffee! </span> </div>
                    ...
                    <div class="col-xs-12 col-sm-2 how-it-works-links color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Choose Coffee Shop</a></li>
                            <li><a href="#">Choose your coffee</a></li>
                            <li><a href="#">Get delivered</a></li>
							<li><a href="#">Pay on delivery</a></li>
							<li><a href="#">Enjoy your coffee :)</a></li>
                        </ul>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Patag</a> </li>
                            <li><a href="#">Tablon</a> </li>
                            <li><a href="#">Cugman</a> </li>
                            <li><a href="#">Tagoloan</a> </li>
                            <li><a href="#">Macabalan</a> </li>
                            <li><a href="#">Divisoria</a> </li>
                            <li><a href="#">Julio Pacana St.</a> </li>
                        </ul>
                    </div>
                </div>
                <!-- top footer ends -->
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                            <h5>Address:</h5>
                            <p>Cagayan de Oro City, Mis Or. - 600034.</p>
                            <h5>Call us at: <a href="tel:+914450005500">+63 92 89538531</a></h5></div>
                        <div class="col-xs-12 col-sm-5 additional-info color-gray">
                            <h5>Who are we?</h5>
                            <p>Launched in 2023, Our technology platform connects customers, coffee shops partners and delivery partners, serving their multiple needs. Customers use our platform to search and discover Always Coffee shops, read and write customer generated reviews and view and upload photos, order coffee delivery, book a table and make payments while ordering nation wide.</p>
                        </div>
                    </div>
                </div>
                <div class="container">
                <h5 style="color:#fff;">Please visit our facebook page.</h5><a href="https://www.facebook.com/profile.php?id=100089853752819" class="fa fa-facebook "></a>
            </div>
            </div>
        </footer>
        <!-- end:Footer -->
