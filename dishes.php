        ...
        <div class="page-wrapper">
            ...
            <div class="top-links">
                <div class="container">
                    <ul class="row links">
                        ...
                        <li class="col-xs-12 col-sm-4 link-item"><span>1</span><a href="coffeeshop.php">Choose Restaurant</a></li>
			...
			<?php $ress= mysqli_query($db,"select * from restaurant where rs_id='$_GET[res_id]'");
									     $rows=mysqli_fetch_array($ress);
										  ...
										  ?>
            <section class="inner-page-hero bg-image" data-image-src="images/banner1.jpg">
                <div class="profile">
                    <div class="container">
                        <div class="row">
...
?>								  
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-6">
                        ...
                        <div class="menu-widget" id="2">
                            <div class="widget-heading">
                                <h3 class="widget-title text-dark">
                              Choose Your Coffee <a class="btn btn-link pull-right" data-toggle="collapse" href="#popular2" aria-expanded="true">
                    ...
                    <div class="row text-img-block text-xs-left">
                        <div class="container">
                            ...
                            <h3>Always Coffee - The Best Coffee Delivery App</h3>
                                <p>Need more energy? Get the coffee you want, from the coffee shop you love, delivered at blinking speed.
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#"> <img src="images/banner1.jpg" alt=""> </a> <span>Choose it &amp; Enjoy your meals! </span> </div>
